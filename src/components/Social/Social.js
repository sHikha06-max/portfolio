    ...
    if (mobile) {
        return (
            <div className={classes.mobileWrapper}>
                <IconBtn icon={GitHub} m={1} href="https://github.com/sHikha06-max" target = "_blank" />
               <IconBtn icon={LinkedIn} m={1} href="https://www.linkedin.com/in/shikha-mishra-279868165/" />
                <IconBtn icon={Email} m={1} href="mailto:mshikha38@gmail.com" />
            </div>
        );
    } else {
        return (
